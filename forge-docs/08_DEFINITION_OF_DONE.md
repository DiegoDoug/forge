...
- [x] Security-review gate for outbound-network-call phases defined for Model Playground: see [ADR-0010](decisions/0010-model-playground-provider-credential-security.md) (Accepted 2026-07-29) and the resulting "Outbound network calls" section in [`../docs/Security.md`](../docs/Security.md). Phase 05's [`08_ACCEPTANCE.md`](implementation/Phase-05-Model-Playground/08_ACCEPTANCE.md) §3 requires both that ADR and the Security.md addendum before the phase is marked complete. Prompt Studio (Phase 03) was specified with zero outbound calls (2026-07-22), so it does not trigger this gate — see [`implementation/Phase-03-Prompt-Studio/01_SPEC.md`](implementation/Phase-03-Prompt-Studio/01_SPEC.md) §5. TODO remaining: generalize this into a standing gate for any *future* outbound-call phase beyond Model Playground, rather than a Phase-05-specific note.
...
- [13_PHASE_LIFECYCLE.md](13_PHASE_LIFECYCLE.md) — where "done" fits in the full Draft→Archived lifecycle
