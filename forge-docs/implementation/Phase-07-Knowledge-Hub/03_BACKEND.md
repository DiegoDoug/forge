...
- [ ] TODO: new `services/<name>/` subpackage, or extension of an existing one? Related existing backend code: `backend/app/notes/, backend/app/documents/, backend/app/ingest/, backend/app/search/`.
