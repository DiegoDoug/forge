...
- [ ] TODO: derive one checklist item per functional requirement in [`01_SPEC.md`](01_SPEC.md) §3.

## 2. UX acceptance criteria

- [ ] TODO: derive from [`02_UI.md`](02_UI.md) — every screen has empty/loading/error states, keyboard access confirmed.
...
- [ ] TODO: who signs off on this phase being complete?

## 5. TODO

- [ ] This document is a template placeholder — fill in against [`01_SPEC.md`](01_SPEC.md) before implementation begins, and keep it in sync as the spec evolves.
