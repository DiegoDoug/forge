...
Consolidate Generators, Crypto, and Utilities under one unified Developer Toolkit navigation umbrella, without changing their underlying service logic.
...
Consolidates the existing **Generators**, **Crypto**, and **Utilities** feature areas — primarily a navigation/UX consolidation, not a service rewrite.
...
- Related backend: `backend/app/generators/, backend/app/crypto/`
