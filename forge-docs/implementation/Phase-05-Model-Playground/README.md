...
- Related frontend: `none yet — new `features/model-playground/``
- Related backend: `none yet — new `services/model_playground/``
...
Introduces outbound network calls and provider API-key storage — requires the security review flagged in [`../../03_ARCHITECTURE.md`](../../03_ARCHITECTURE.md) §4 before implementation.
