...
- [ ] TODO: new `services/<name>/` subpackage, or extension of an existing one? Related existing backend code: `backend/app/vault/, backend/app/notes/, backend/app/documents/`.
