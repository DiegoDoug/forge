...
Provide a workspace for authoring, versioning, and testing LLM prompts, with reusable prompt templates and structured variables.

New capability. Shares LLM-provider plumbing with Phase 05 (Model Playground) — sequencing between the two is an open question, see [`../../02_ROADMAP.md`](../../02_ROADMAP.md) §4.
