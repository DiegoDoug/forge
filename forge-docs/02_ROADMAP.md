...
| 05 | [Model Playground](implementation/Phase-05-Model-Playground/README.md) | New — test/compare LLM providers and models | Release Candidate — Owner Sign-off recorded, PR in preparation ([ADR-0010](decisions/0010-model-playground-provider-credential-security.md)/[ADR-0011](decisions/0011-model-playground-provider-sdk-selection.md)) |
